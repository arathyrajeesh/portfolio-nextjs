...
const Hero = () => {
    ...
    return (
        <div id="hero" className='relative h-screen flex items-center justify-center text-white overflow-hidden flex-col'>
        <ParticlesHero />
        ...
        <div className='relative z-10 flex flex-col items-center'>
            ...
            <span className='text-cyan-200 font-bold'>
                <Typewriter
                options={{
                    strings: [' Frontend Developer', ' Backend Developer', ' Web Developer', ' Python FullStack Developer'],
                    autoStart: true,
                    loop: true,
                    delay: 75,
                    deleteSpeed: 50,
